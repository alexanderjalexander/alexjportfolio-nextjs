  ...
  try {
    ...
    return (
      <div className="m-auto w-fit pb-6 text-xs text-center">
        <div>
          &lt;-{' '}
          <a className="text-xs" href={neighbors[0].url}>
            {neighbors[0].name}
          </a>
          &bull;{' '}
          <a className="text-xs" href={random.url}>
            Random
          </a>
          &bull;{' '}
          <a className="text-xs" href={neighbors[1].url}>
            {neighbors[1].name}
          </a>
          -&gt;
        </div>
        <div>
          ...
          <a className="text-xs" href={'https://github.com/Stevens-26/webring'}>
