...
export async function GET(req: Request) {
  ...
  try {
    const paths = [
        '/', '/programming', '/video', '/motion_graphics', '/graphic_design', '/3d_animation', '/api-reference', 
        '/api/animation', '/api/graphic_design', '/api/motion', '/api/programming', '/api/video', '/api/video/commissions'
    ];
