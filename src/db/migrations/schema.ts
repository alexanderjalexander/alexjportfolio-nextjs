...
export const animationSkills = pgTable(
  "animation_skills",
  {
...
export const motionGraphicsSkills = pgTable(
  "motion_graphics_skills",
  {
    project: integer().notNull(),
    skill: integer().notNull(),
  },
...
export const programmingProjects = pgTable(
  "programming_projects",
  {
    ...
    link: varchar({ length: 75 }),
  },
  (table) => [unique("programming_projects_title_key").on(table.title)],
);

export const programmingSkills = pgTable(
  "programming_skills",
  {
    project: integer().notNull(),
    skill: integer().notNull(),
...
export const creators = pgTable(
  ...
  (table) => [unique("creators_channel_id_key").on(table.channelId)],
);
...
export const workExperienceSkills = pgTable(
